...
/* priority:
  - node-gyp on ENV:NODE_PRE_GYP_NODE_GYP, which npm leaves alone where it resets npm_config_node_gyp
...
function which_node_gyp() {
  let node_gyp_bin;
  if (process.env.NODE_PRE_GYP_NODE_GYP) {
    node_gyp_bin = process.env.NODE_PRE_GYP_NODE_GYP;
